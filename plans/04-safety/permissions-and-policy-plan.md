...
- Browser attribute wait classification: `03 browser wait-attribute` is classified as a low-risk non-mutating verification because it reports only value lengths and digests.
- Browser form mutation enforcement: `03 browser fill` is classified as a medium-risk mutating action because it changes page state and may enter private text into a web app.
