...
final class Ln1PolicySystemSmokeTests: Ln1TestCase {
    ...
    func testBenchmarksMatrixReturnsRealAppCoverageTargets() throws {
        ...
        XCTAssertTrue(apps.contains("Visual fallback stress apps"))
        ...
        XCTAssertTrue(allSurfaces.contains("canvas apps"))
        XCTAssertTrue(allSurfaces.contains("video players"))
        XCTAssertTrue(allSurfaces.contains("maps"))
        XCTAssertTrue(allSurfaces.contains("games"))
        XCTAssertTrue(allSurfaces.contains("broken Accessibility trees"))
        ...
        XCTAssertTrue(allCapabilities.contains("desktop screenshot"))
        XCTAssertTrue(allCapabilities.contains("browser screenshot"))
        XCTAssertTrue(allCapabilities.contains("OCR"))
        ...
        XCTAssertTrue(allVerificationCommands.contains { $0.contains("browser screenshot") })
